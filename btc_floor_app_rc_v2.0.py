...
def main():
    ...
    with strat_tab1:
        ...
        **Simulazione Monte Carlo**: Qual è la probabilità che BTC tocchi ogni livello nei prossimi **{horizon_months} mesi**?
        ...
        def calculate_entry_probabilities(_df_close, _df_days, current_price, today_days, floor_params, qr_params, n_sims=10000, horizon_days=730):
        ...
        with st.spinner("Calcolando probabilità..."):
            prob_df = calculate_entry_probabilities(
                ...
                n_sims=10000, horizon_days=horizon_months * 30
            )
        ...
        **Come avrebbero performato queste strategie nel passato?**
        ...
        for strategy in bt_results.columns:
            ...
            stats_data.append({
                ...
                'Sharpe': f"{returns.mean() / returns.std():.2f}" if returns.std() > 0 else "N/A",
